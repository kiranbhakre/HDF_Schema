...
public class SampleSchemaRegistryClientApp {
    ...
    public static final String DEFAULT_SCHEMA_REG_URL = "http://localhost:7788/api/v1";
    ...
    public void runSchemaApis() throws Exception {
        ...
        String schemaFileName = "customer-v1.avsc";
        ...
        Collection<SchemaVersionInfo> allVersions_t = schemaRegistryClient.getAllVersions(schemaMetadata.getName());
        LOG.info("All versions of schema key [{}] is : [{}]", schemaMetadata, allVersions_t);
    ...
    private String getSchema(String schemaFileName) throws IOException {
        InputStream schemaResourceStream = SampleSchemaRegistryClientApp.class.getClassLoader().getResourceAsStream(schemaFileName);
